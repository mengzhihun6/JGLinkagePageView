...
@end
@implementation JGCatergoryViewCell
...
- (void)setProperty:(JGCatergoryViewProperty *)property{
    _property = property;
...
- (void)setData:(JGCatergoryViewCellModel *)data{
    _data = data;
...
- (void)xwp_interpolationColor{
    ...
    if (_property.titleColorChangeEable) {
        if (_property.titleColorChangeGradually) {
            ...
            _titleLabel.textColor = [UIColor jg_colorWithInterpolationFromValue:_property.titleColor toValue:_property.titleSelectColor ratio:_data.valueRatio];
